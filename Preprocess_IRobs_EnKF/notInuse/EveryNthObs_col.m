function [myTimes,mySat_name,myChNum,myLat,myLon,myTb,myROI_hydro,myROI_other,myObsErr,mySat_alt] = EveryNthObs_col(DAtime, Ch, min_WRF_lat, max_WRF_lat, min_WRF_lon, max_WRF_lon, Tb_file, control)

    % Read GOES obs 
    [lat_col,lon_col,Tb_col] = Read_GOES_for_EveryNthObs_col(Tb_file);
