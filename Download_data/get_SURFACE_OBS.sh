#!/bin/csh
#################################################################
# Csh Script to retrieve 21 online Data files of 'ds461.0',
# total 2.15G. This script uses 'wget' to download data.
#
...
set opt2 = "email=yao.zhu.91@gmail.com&passwd=$pswd&action=login"
$opt $opt1="$opt2" https://rda.ucar.edu/cgi-bin/login
set opt1 = "-N --load-cookies auth.rda_ucar_edu"
set opt2 = "$opt $opt1 https://rda.ucar.edu/data/ds461.0/"
set filelist = ( \
