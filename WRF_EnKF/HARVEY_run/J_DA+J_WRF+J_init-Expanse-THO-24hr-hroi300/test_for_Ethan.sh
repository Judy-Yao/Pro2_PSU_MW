...
export CONFIG_FILE=/expanse/lustre/projects/pen116/zuy121/Pro2_PSU_MW/SourceCode/WRF_EnKF/HARVEY_run/J_DA+J_WRF+J_init-Expanse-THO-24hr-hroi300/config_THO.HARVEY
#!!!!!!!!!!!!!!!!!! Attention !!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
while [[ $NEXTDATE -le $DATE_CYCLE_END ]]; do
  ...
  # run components
  # ------------------
  "$SCRIPT_DIR"/module_icbc_test.sh
