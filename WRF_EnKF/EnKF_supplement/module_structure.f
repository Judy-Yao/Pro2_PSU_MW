...
!-- enkf_parameter
   ...
   real          :: mixing_core
   logical       :: random_order 
   integer       :: print_detail        ! used to debug the code
   logical       :: use_estimate_inf    ! .true. : apply <whatever this is>

!-- parallel
   logical       :: manual_parallel
...
!-- use_radiance
   ...
   logical       :: use_aoei_radiance   ! .true. : apply Adaptive Observation Error Inflation
   logical       :: use_elf_radiance    ! .true. : apply Empirical Localization Function
   logical       :: use_inf_bt_radiance ! .true. : apply Empirical BT-based inflation 
...
!-- use_microwave
   ...
   integer       :: vroi_microwave       ! vertical radius of influence for microwave if use_vroi_microwave_halfsfc = .false.
   logical       :: use_vroi_microwave_halfsfc ! .true. : VROI is set to (obs-level)*2, .false.:vroi_microwave is used
   logical       :: use_aoei_microwave   ! .true. : apply Adaptive Observation Error Inflation
   logical       :: use_elf_microwave    ! .true. : apply Empirical Localization Function
   logical       :: use_inf_bt_microwave ! .true. : apply Empirical BT-based inflation
...
!-- Namelist contents :
   ...
   namelist /enkf_parameter / numbers_en, expername, enkfvar, updatevar,                          &
                                 ...
                                 random_order, print_detail, use_estimate_inf
   ...
   namelist /radiance       / use_radiance,datathin_radiance,hroi_radiance,vroi_radiance,use_vroi_radiance_halfsfc, &
                                 use_aoei_radiance,use_elf_radiance,use_inf_bt_radiance
   namelist /microwave      / use_microwave,datathin_microwave,hroi_microwave,vroi_microwave,use_vroi_microwave_halfsfc, &
                                 use_aoei_microwave,use_elf_microwave,use_inf_bt_microwave, &
                                 use_slant_path
