function [all_Tbfile_name ] = Collect_GOESR(istorm, bestrack_str, control)
    ...
    for i = 1:length(Tb_files)
        ...
        if use_Tb_file == 0
            ...
            if isempty(ir) 
                ...
                newfile_name = ['DAt' + time_btk_str(ir) + '_GOESR_ABI_L2_CMIPF_CH8.nc'];
                ...
                all_Tbfile_name = [all_Tbfile_name,newfile_name];
            end 
        end
    end 
