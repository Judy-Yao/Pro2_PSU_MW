function [] = Plot(storm_phase, platform, sensor, min_lat_dpy, max_lat_dpy, min_lon_dpy, max_lon_dpy, time, loc_storm, lat_need, lon_need, Tb_need, DAtime, ChName,control)
        ...
        title_char = [title_char1,ChName,time];
