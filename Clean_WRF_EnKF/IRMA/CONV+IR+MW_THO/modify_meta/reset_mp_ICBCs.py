...
def modify_wrf_meta( file_path ):
    ...
    if "MP_PHYSICS" in nc_file.ncattrs():
        nc_file.setncattr("MP_PHYSICS", 6)  # Set the new value: WSM6
        print("MP_PHYSICS changed to 6")
    else:
        print("MP_PHYSICS not found. Adding it...")
        nc_file.setncattr("MP_PHYSICS", 6)
...
def modify_fc():
    ...
    fc_path = data_dir+'fc/201709151200/'
...
def modify_rc():
    ...
    rc_path = data_dir+'rc/201709151200/'
...
if __name__ == '__main__':
    ...
    data_dir = '/scratch/06191/tg854905/Clean_Pro2_PSU_MW/MARIA/CONV_WSM6/'
