...
contains
  ...
  subroutine model_state_read_wrf(state, filename_wrf, time_idx, error_status, buffer)
    ...
    call get_variable3d_local(fid,'THM',       xbeg1, xend1, ybeg1, yend1, 1, zmax,  time_idx, t)
...
!    real, _ALLOCATABLE :: phis(:,:)     _NULL  ! Surface geopotential (g*Z_surf)
    ...
    call get_variable3d_local(fid,'THM',    xbeg1, xend1, ybeg1, yend1, 1, zmax, time_idx, state%temperature) ! temperature (K)
