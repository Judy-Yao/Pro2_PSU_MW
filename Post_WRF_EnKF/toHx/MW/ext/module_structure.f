...
!-- use_microwave
   ...
   logical       :: use_vroi_microwave_halfsfc ! .true. : VROI is set to (obs-level)*2, .false.:vroi_radiance is used
...
!-- Namelist contents :
   ...
   namelist /enkf_parameter / numbers_en, expername, enkfvar, updatevar,                          &
                                 ...
                                 inflate, mixing, use_vortex_RTPP, mixing_core, random_order, print_detail, &
                                 use_estimate_inf, use_elf
   ...
   namelist /radiance       / use_radiance, datathin_radiance, hroi_radiance, vroi_radiance, &
                                 use_vroi_radiance_halfsfc, use_aoei_radiance, use_inf_bt_radiance
   namelist /microwave      / use_microwave, datathin_microwave, hroi_microwave, vroi_microwave, &
                                 use_vroi_microwave_halfsfc, use_aoei_microwave, use_inf_bt_microwave
...
!                    - 
   ...
   type obs_type
       ...
       real, allocatable, dimension(:,:)         :: sta           !! (ob_num,4)
                                                                  ...
                                                                  !! for microwave obs, it include satellite (latitude, longtidue, altitude)
       integer, allocatable, dimension(:,:)      :: roi           !! (ob_num,3) : 1=horizontal, 2=vertical, 3=h.(non-Q in radiance, microwave)
