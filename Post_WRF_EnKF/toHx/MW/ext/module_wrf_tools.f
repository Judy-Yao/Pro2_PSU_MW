...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        select case (mapp)
          case(1)
            call map_set(PROJ_LC, projt, lat1=la1, lon1=lo1, &
                            dx=grid_space, stdlon=cen_lon,   &
                            truelat1=truelat1, truelat2=truelat2, &
                            nlon=ix, nlat=iy)
          case(2)
!            call map_set(PROJ_PS, la1, lo1, grid_space, cen_lon,   &
!                             truelat1, truelat2, ix, iy, projt)
            call map_set(PROJ_PS, projt, lat1=la1, lon1=lo1, &
                            dx=grid_space, stdlon=cen_lon,   &
                            truelat1=truelat1, truelat2=truelat2, &
                            nlon=ix, nlat=iy)
          case(3)
...
!                             truelat1, truelat2, ix, iy, projt)
            call map_set(PROJ_MERC, projt, lat1=la1, lon1=lo1, &
                            dx=grid_space, stdlon=cen_lon,   &
                            knowni=1., knownj=1., &
                            truelat1=truelat1, truelat2=truelat2, &
                            nlon=ix, nlat=iy)
