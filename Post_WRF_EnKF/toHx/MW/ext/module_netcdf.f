...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
!   write_variable4d - subroutine that writes netcdf data for a 3 
!                      dimensional quantity
!
!      fid - integer file id
!      var - name of the variable to write
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      subroutine write_variable4d(fid, var, i1, i2, i3, i4, it, dat)

      character (len=*), intent(in) :: var
      integer, intent(in)           :: fid, i1, i2, i3, i4, it
      real, intent(in)              :: dat(i1,i2,i3,i4)

      integer :: istart(5), iend(5), varid, rcode
      ...
      if (rcode.ne.0) then 
        call netcdf_error('write_variable4d', var, rcode, i1, i2, i3,it)
      endif

      end subroutine
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
!   write_variable2d_nontime - subroutine that writes netcdf dat for a 2
!                      dimensional quantity, time invariant
!
!      fid - integer file id
!      var - name of the variable to write
!       i1 - x dimension size
...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      subroutine write_variable2d_nontime(fid, var, i1, i2, dat)

      character (len=*), intent(in) :: var
      integer, intent(in)           :: fid, i1, i2
      real, intent(in)              :: dat(i1,i2)
      ...
      if (rcode.ne.0) then 
        call netcdf_error('write_variable2d', var, rcode, i1, i2, 0, 0)
      endif
