...
!  stop
  ...
  call model_state_read_hrrr(state, filename_in, 1, 'rap', error_status, buffer=0)
  ...
  !filename_obs = '/scratch/05012/tg843115/tmp/test_forward_rt/microwave_201708231200_so'
  filename_obs = nml_s_filename_obs
!  '/home1/05012/tg843115/src/extractsatob/test/out/test_202003270100_gmi_ch03x018x018_ch13x009x009.txt'
  !filename_obs = '/scratch/05012/tg843115/EnKF_forecast/harvey_limMW_origcrtm2/run_unthinned/201708231200/enkf/d03/microwave_201708231200_so'
...
!    print *, 'obs_num:', obs_mw%num
!    print *, 'obs_ch:', obs_mw%ch
!    print *, 'obs_ii:', obs_mw%ii
!    print *, 'obs_jj:', obs_mw%jj
  end if
