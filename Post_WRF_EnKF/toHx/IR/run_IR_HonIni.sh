...
Exper=IR-J_DA+J_WRF+J_init-SP-intel17-WSM6-30hr-hroi900/fc/
...
date_st=201709041200        # Start date  
...
wrffile=${Big_dir}/${Storm}/${Exper}/${DAtime}/wrfinput_d03
outfile=${Big_dir}/${Storm}/${Exper}/${DAtime}/CRTM_wrfinput_d0${dom}_${year}-${month}-${day}_${hour}:${minute}:00.bin
