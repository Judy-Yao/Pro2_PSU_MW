...
Storm=IRMA
Exper=IR-THO_onlyTCvitals

# Parent paths
Big_dir=/expanse/lustre/scratch/zuy121/temp_project/Pro2_PSU_MW/
...
date_st=201709030100        # Start date  
date_ed=201709031200        # End date (24 forecast hrs can be done in < 2 hr w/4 nodes on skx queues)
