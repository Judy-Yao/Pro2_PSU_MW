...
# Parent paths
Big_dir=/work2/06191/tg854905/stampede2/Pro3_MPcsst_CRTM/Collected_Model/Forecasts/
...
date_st=201908282000        # Start date  
date_ed=201908282200        # End date (24 forecast hrs can be done in < 2 hr w/4 nodes on skx queues)
