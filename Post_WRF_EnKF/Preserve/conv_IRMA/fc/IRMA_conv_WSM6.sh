...
#####header for stampede######
#SBATCH -J IRMAconvWSM6
#SBATCH -N 1
#SBATCH --ntasks-per-node 48
#SBATCH -p icx-normal
#SBATCH -t 35:00:00
#SBATCH -o out_IRMA_conv_WSM6
#SBATCH -e error_IRMA_conv_WSM6
...
DA=conv
MP=WSM6
Exper=J_DA+J_WRF+J_init-SP-intel17-WSM6-30hr-hroi900
# Specify time range
spinup_st=201709021200
date_st=201709030000
date_ed=201709040000
