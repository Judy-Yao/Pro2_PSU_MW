...
#####header for stampede######
#SBATCH -J MARIAconvWSM6
#SBATCH -N 1
#SBATCH --ntasks-per-node 48
#SBATCH -p icx-normal
#SBATCH -t 25:00:00
#SBATCH -o out_fc_MARIA_IR_WSM6
#SBATCH -e error_fc_MARIA_IR_WSM6
...
DA=conv
MP=WSM6
Exper=J_DA+J_WRF+J_init-SP-intel17-WSM6-24hr-hroi900
# Specify time range
spinup_st=201709151200
date_st=201709160000
date_ed=201709170000
