...
#SBATCH -p icx-normal
#SBATCH -t 30:00:00
#SBATCH -o out_fc_MARIA_IR_MD
#SBATCH -e error_fc_MARIA_IR_MD
...
DA=IR
MP=TuneWSM6
Exper=IR-TuneWSM6-J_DA+J_WRF+J_init-SP-intel17-WSM6-24hr-hroi900
# Specify time range
spinup_st=201709151200
date_st=201709170900
date_ed=201709180000
