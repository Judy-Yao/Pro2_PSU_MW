...
def read_USAF_mission( time_mission, mission_path, attr_itt ):
    ...
    return dict_AF_mission, uni_hhdd
...
def mask_time( dict_AF_all, wrf_hh, Nminutes ):
    ...
    year = dict_AF_all['times'][0].year
    month = dict_AF_all['times'][0].month
    day= dict_AF_all['times'][0].day
    hh = wrf_hh
    ...
    if time_start not in dict_AF_all['times']:
        print('AF obs does not exist within +/- 15 minutes at this hour!')
        dict_AF_masked = None
