...
def plot_var_incre_timeseries( small_dir, Storm, Exper_name, DAtimes, var, P_interest, ave_var_overT ):
    ...
    if 'Q' in var: 
        ...
        incre_contourf = ax.contourf( xcoor, ycoor, np.transpose( ave_trans_Q ), cmap=Hydromap, vmin=nega_min-20, vmax=posi_max+20,levels=bounds,extend='both')
        # Add color bar below the plot
...
def eachVar_plot( big_dir, small_dir, Storm, Exper_name, DAtimes, v_interest ):
    ...
    for var_name in v_interest:
        ...
        for DAtime in DAtimes:
            ...
            idx_zero = np.where( abs(var_interp) <= 1e-12 )[0]
...
if __name__ == '__main__':
    ...
    start_time_str = '201709140000'
    end_time_str = '201709141000'
